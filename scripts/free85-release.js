...
if (performance.phase !== "16" || performance.release !== packageJson.version) {
...
const manifest = {
  ...
  status: packageJson.version === "2.21.0" ? "stable" : "development",
  license: "MIT",
  persistent_ram: {
    schema: 13,
    status: "frozen",
  ...
  release_notes: "docs/Free85-2.21-engineering-handoff.md",
