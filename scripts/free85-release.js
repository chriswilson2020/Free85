...
if (performance.phase !== "15.3" || performance.release !== packageJson.version) {
...
const manifest = {
  ...
  status: packageJson.version === "2.16.0" ? "stable" : "development",
  license: "MIT",
  persistent_ram: {
    schema: 13,
    status: "frozen",
  ...
  release_notes: "docs/Free85-2.16-release.md",
