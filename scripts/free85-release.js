...
if (performance.phase !== "14.10" || performance.release !== packageJson.version) {
...
const manifest = {
  ...
  status: packageJson.version === "2.10.0" && coverage.phase === "14.10" ? "stable" : "development",
  license: "MIT",
  persistent_ram: {
    schema: 13,
    status: "frozen",
  ...
  release_notes: "docs/Free85-2.0-release.md",
