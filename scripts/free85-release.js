...
if (performance.phase !== "15.6" || performance.release !== packageJson.version) {
...
const manifest = {
  ...
  status: packageJson.version === "2.20.0" ? "stable" : "development",
  license: "MIT",
  persistent_ram: {
    schema: 13,
    status: "frozen",
  ...
  release_notes: "docs/Free85-2.20-release.md",
