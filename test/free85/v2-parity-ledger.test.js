...
test("[v2.progress] Phase 14.6 closes real list/vector gaps without hiding complex matrix work", async () => {
  ...
  assert.equal(report.gaps.byStatus.equivalent, 20);
  assert.equal(report.gaps.equivalentPercent, 55.56);
